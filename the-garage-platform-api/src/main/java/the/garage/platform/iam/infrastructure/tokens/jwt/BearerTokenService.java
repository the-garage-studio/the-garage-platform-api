package the.garage.platform.iam.infrastructure.tokens.jwt;
 ...
 * This interface is used to inject the JWT token service in the {@link the.garage.platform.iam.infrastructure.tokens.jwt.services.TokenServiceImpl} class.
 */
